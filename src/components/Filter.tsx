  ...
  return (
    <div className="flex relative flex-col justify-between my-5">
      ...
      <div
        ...
        ref={carousel}
      >
        <div className="min-w-2 xl:min-w-8 h-px"></div>
        <CardCategory
          category="Todas"
          value="todas"
          icon={<Hand />}
        ...
        <FilterSeparator name="hot dogs">
          <CardCategory value="hotdog" category="Hot Dogs" icon={<HotDog />} />
        </FilterSeparator>
        ...
        <div className="min-w-px xl:min-w-8 h-px"></div>
      </div>
